...
LinkedIn is not a broadcasting platform. It is a **trust accumulation engine**. Every post, comment, and message either deposits or withdraws trust. People buy from people they trust.

Most people use LinkedIn like a billboard. The best use it like a relationship ledger.

**Personal brands outperform company pages by 5-10x.** Build the founder/expert brand. The company benefits downstream.
...
| Format | Purpose | Frequency | Sweet Spot |
|--------|---------|-----------|------------|
...
## Comments Strategy (Summary)

Comments are **distribution borrowed from other people's audiences**. A substantive comment on a high-traffic post can drive more profile views than your own post.

A good comment does ONE of: extends the idea, challenges it, personalises it with experience, quantifies it, or reframes it.

Never just agree. Never pitch. Never be obviously AI-generated.

See **`references/comments.md`** for full comment anatomy, targeting tiers, timing, and dos/don'ts.
...
The single most important rule: if your message could have been sent to 100 people with a name-swap, delete it.

See **`references/dms.md`** for full DM anatomy, worked examples, follow-up rules, and red flags.

## Profile Optimisation (Summary)

Profile is where people go after reading a post. If it's weak, you lose the conversion.

- **Headline:** Not your job title. Who you help + what outcome. "I help scale-ups eliminate technical debt without freezing product development"
- **About:** Problem → your approach → proof → CTA
- **Featured:** Best carousel + best Article + website or lead magnet
- **Experience:** Outcomes, not responsibilities

See **`references/profile-and-engagement.md`** for full profile structure and daily engagement system.
